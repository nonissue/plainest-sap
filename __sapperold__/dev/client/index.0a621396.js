...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 53, 6, 1100);
			attr_dev(li, "class", "svelte-1gudrur");
			add_location(li, file, 52, 4, 1089);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(48:2) {#each posts as post}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 44, 0, 820);
			attr_dev(ul, "class", "svelte-1gudrur");
			add_location(ul, file, 46, 0, 838);
		},
		m: function mount(target, anchor) {
