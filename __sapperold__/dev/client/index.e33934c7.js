...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 54, 6, 1147);
			attr_dev(li, "class", "svelte-1gudrur");
			add_location(li, file, 53, 4, 1136);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 45, 0, 867);
			attr_dev(ul, "class", "svelte-1gudrur");
			add_location(ul, file, 47, 0, 885);
		},
		m: function mount(target, anchor) {
