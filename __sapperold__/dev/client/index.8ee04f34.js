...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 52, 6, 1104);
			attr_dev(li, "class", "svelte-vk0eel");
			add_location(li, file, 51, 4, 1093);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 43, 0, 820);
			attr_dev(ul, "class", "svelte-vk0eel");
			add_location(ul, file, 45, 0, 838);
		},
		m: function mount(target, anchor) {
