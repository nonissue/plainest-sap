...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 80, 6, 1993);
			add_location(code, file, 82, 6, 2067);
			add_location(li, file, 79, 4, 1982);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(i, file, 72, 2, 1700);
			add_location(h2, file, 73, 2, 1718);
