...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 79, 6, 1946);
			add_location(code, file, 81, 6, 2020);
			add_location(li, file, 78, 4, 1935);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 72, 0, 1667);
		},
		m: function mount(target, anchor) {
