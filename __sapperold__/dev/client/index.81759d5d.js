...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a0, "class", "svelte-1qpr6iw");
			add_location(a0, file, 59, 6, 1089);
			add_location(code, file, 62, 8, 1218);
			attr_dev(a1, "rel", "prefetch");
			attr_dev(a1, "href", a1_href_value = "author/" + /*post*/ ctx[1].author);
			attr_dev(a1, "class", "svelte-1qpr6iw");
			add_location(a1, file, 61, 6, 1163);
			attr_dev(li, "class", "svelte-1qpr6iw");
			add_location(li, file, 58, 4, 1078);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h2, "class", "svelte-1qpr6iw");
			add_location(h2, file, 50, 0, 804);
			attr_dev(ul, "class", "svelte-1qpr6iw");
			add_location(ul, file, 52, 0, 827);
		},
		m: function mount(target, anchor) {
