...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(code, file, 53, 8, 1081);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", a_href_value = "author/" + /*post*/ ctx[1].author);
			add_location(a, file, 52, 6, 1026);
			attr_dev(li, "class", "svelte-11cj3xt");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 43, 0, 746);
			attr_dev(ul, "class", "svelte-11cj3xt");
			add_location(ul, file, 45, 0, 764);
		},
		m: function mount(target, anchor) {
