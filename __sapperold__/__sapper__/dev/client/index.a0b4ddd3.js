...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a0, "class", "svelte-10utq1i");
			add_location(a0, file, 61, 6, 1126);
			add_location(code, file, 64, 8, 1255);
			attr_dev(a1, "rel", "prefetch");
			attr_dev(a1, "href", a1_href_value = "author/" + /*post*/ ctx[1].author);
			attr_dev(a1, "class", "svelte-10utq1i");
			add_location(a1, file, 63, 6, 1200);
			attr_dev(li, "class", "svelte-10utq1i");
			add_location(li, file, 60, 4, 1115);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h2, "class", "svelte-10utq1i");
			add_location(h2, file, 52, 0, 841);
			attr_dev(ul, "class", "svelte-10utq1i");
			add_location(ul, file, 54, 0, 864);
		},
		m: function mount(target, anchor) {
