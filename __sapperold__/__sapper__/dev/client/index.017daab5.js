...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 52, 6, 1116);
			attr_dev(li, "class", "svelte-22unl3");
			add_location(li, file, 51, 4, 1105);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 43, 0, 832);
			attr_dev(ul, "class", "svelte-22unl3");
			add_location(ul, file, 45, 0, 850);
		},
		m: function mount(target, anchor) {
