...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 82, 6, 2003);
			add_location(code, file, 84, 6, 2077);
			add_location(li, file, 81, 4, 1992);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(77:2) {#each posts as post}",
		ctx
	});
