...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 79, 6, 1984);
			add_location(code, file, 81, 6, 2058);
			add_location(li, file, 78, 4, 1973);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 72, 2, 1700);
