...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a0, "class", "svelte-isn4jn");
			add_location(a0, file, 64, 6, 1211);
			add_location(code, file, 67, 8, 1340);
			attr_dev(a1, "rel", "prefetch");
			attr_dev(a1, "href", a1_href_value = "author/" + /*post*/ ctx[1].author);
			attr_dev(a1, "class", "svelte-isn4jn");
			add_location(a1, file, 66, 6, 1285);
			attr_dev(li, "class", "svelte-isn4jn");
			add_location(li, file, 63, 4, 1200);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			attr_dev(h2, "class", "svelte-isn4jn");
			add_location(h2, file, 55, 0, 926);
			attr_dev(ul, "class", "svelte-isn4jn");
			add_location(ul, file, 57, 0, 949);
		},
		m: function mount(target, anchor) {
