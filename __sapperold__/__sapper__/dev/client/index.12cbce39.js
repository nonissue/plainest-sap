...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 51, 4, 1075);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 43, 0, 802);
			attr_dev(ul, "class", "svelte-1gudrur");
			add_location(ul, file, 45, 0, 820);
		},
		m: function mount(target, anchor) {
