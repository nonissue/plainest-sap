...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 52, 6, 1098);
			attr_dev(li, "class", "svelte-1noua91");
			add_location(li, file, 51, 4, 1087);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 43, 0, 814);
			attr_dev(ul, "class", "svelte-1noua91");
			add_location(ul, file, 45, 0, 832);
		},
		m: function mount(target, anchor) {
